...
start_message = ('🤩 Приветствую Вас!🤩\n\n'
                 '✅ Качественный и проверенный продавец TG_MAGNAT\n\n'
                 '🚀 C помощью бота "TG_MAGNAT" вы сможете приобрести TG_аккаунты в формате <b><u>Session+Json</u></b> ')

rules_text = """
📣❗️Правила использования аккаунтов ❗️​

- Аккаунты предоставляются в формате <b><u>Session+Json</u></b>, исключительно для индивидуального использования и предназначены только для софта.
- Время на проверку аккаунтов после покупки составляет 15 минут! (Все аккаунты проверяются перед продажей)
Прилагайте запись экрана в качестве доказательства.
По истечении этого времени претензии не принимаются.
- Категорически запрещено использование ТОР-прокси и некачественных прокси-сервисов, таких как Astra, Asocks и IPRoyal❗️
- Начинайте проверку аккаунтов с небольшого объема.

По всем вопросам: https://t.me/TG_MAGNAT_TG
"""

# Главное меню
register_kb_text = "🔑 Регистрация (Только Имя)"
start_catalog_text = "🔥 Каталог товаров 🔥"
start_order_text = "👀 Заказы"
start_basket_text = "🛒 Корзина"
politica = 'Правила покупки'
...
category_not_found = '😞 В категорию ожидаются поступления'
